...
//  vector 14 IRQ0
__interrupt(vect=14) void INT_IRQ0(void) {func_SW(1);}
//  vector 15 IRQ1
__interrupt(vect=15) void INT_IRQ1(void) {func_SW(2);}
//  vector 16 IRQ2
__interrupt(vect=16) void INT_IRQ2(void) {func_SW(3);}
//  vector 17 IRQ3
__interrupt(vect=17) void INT_IRQ3(void) {func_SW(4);}
//  vector 18 WKP
