...
#include "iodefine.h"	//iodefine.hを使うためのヘッダー
#include "lcd_func.h"	//LCDを使うためのヘッダー
#include <machine.h>
...
void main(void)
{
	...
	{				
		...
		switch(result)	//送られてきた数値によって結果を表示する
		{
			case 1:	lcd_xy(1,1);
					lcd_puts("You Lose...    ");	//敗北した時に表示する
					break;
			case 2:	lcd_xy(1,1);
					lcd_puts("You Win!!       ");	//勝利した時に表示する
					break;	
			case 3:	lcd_xy(1,1);
					lcd_puts("Draw!           ");	//あいこの時に表示する
					break;		
		}	
		wait(20);	
	}			
